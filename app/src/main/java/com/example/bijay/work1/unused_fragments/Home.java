package com.example.bijay.work1.unused_fragments;
...
public class Home extends Fragment {
    ...
    FrameLayout mframe;
    ImageView mpro;
    TextView musername,musermob,musename,musephone;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        musename=(TextView) view.findViewById(R.id.usename);
        musephone=(TextView) view.findViewById(R.id.usephone);





        mnavbar=view.findViewById(R.id.navbar);
