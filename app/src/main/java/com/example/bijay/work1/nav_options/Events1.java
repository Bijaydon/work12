...
public class Events1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mprofile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent profile=new Intent(Events1.this,Profile.class);
    ...
    public void selectItemDrawer(MenuItem menuItem){
        ...
        switch (menuItem.getItemId()){
            case R.id.home:
                ...
                Intent b =new Intent(Events1.this,homepage.class);
                startActivity(b);
                break;
            case R.id.event:
                ...
                Intent eventintent =new Intent(Events1.this,Events1.class);
            ...
            case R.id.settings:
                ...
                Intent settingintent =new Intent(Events1.this,Setting1.class);
            ...
            case R.id.about:
                ...
                Intent aboutintent =new Intent(Events1.this,About1.class);
            ...
            default:
                ...
                Intent d =new Intent(Events1.this,homepage.class);
                startActivity(d);
    ...
    private void logout() {
        ...
        mAuth.signOut();
        Intent backintent=new Intent(Events1.this,MainActivity.class);
    ...
    public void onBackPressed() {
        ...
        Intent bak =new Intent(Events1.this,homepage.class);
        startActivity(bak);
    }
